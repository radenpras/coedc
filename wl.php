...
body {
    ...
    margin: 0;
    padding: 0;
    background: linear-gradient(to bottom right,#fdcb6e, #d63031);
    display: flex;
...
<option value="FXVP - BAYAH CIKOTOK KM 8">FXVP - BAYAH CIKOTOK KM 8</option>
...
<option value="FHIP - RAYA SERANG PALIMA">FHIP - RAYA SERANG PALIMA</option>
      ...
      <label for="password">NO SN</label>
      <input type="text" name="MID">
...
&nbsp;
<marquee behavior="scroll" style="color:white; ">Jika Sudah Pernah CO, Mohon untuk Tidak Double CO</marquee>
...
function myFunction() {
 ...
 alert("Complain Sukses, Silahkan Tunggu Perbaikan Dari Vendor Wirecard");
}
</script>
